...
| 不能把配点缺陷小直接写成严格可行 | `N=31` 虽有 `s≈0` 和配点缺陷 `1.42e-14`，但因重积分质量误差 `0.704 kg`、速度误差 `0.0302 m/s`，状态为 `needs_relaxation` | `questions/q3/results.md` | resolved |
...
| 指标 | 数值 |
|---|---:|
| `solver_status` | `needs_relaxation` |
